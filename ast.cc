...
Expression print(Expression e1, int type) { Print* expr = new Print(e1, type); return expr; }
Expression read(Symbol var, int type) { Read* expr = new Read(var, type); return expr; }
